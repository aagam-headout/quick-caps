...
// Re-exported, not defined here: these live in flatten.js so the extract layer
// can flatten regions without dragging in tokenize.js's BPE table (see that
// file's header). They remain part of the published `quick-caps-core/distill`
// surface, unchanged, because consumers on npm import them from here.
export {
  SCORE_WEIGHTS,
  scoreOf,
  flattenRegions,
