...
export const LOGS_ATTRIBUTE = 'data-quickcaps-logs';
 ...
 */
export const FETCH_RESOURCE = '__quickcaps-fetch-resource';
 ...
 */
export const SERIALIZE_PROGRESS = '__quickcaps-serialize-progress';
